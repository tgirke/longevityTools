...
# Connectivity maps enrichment analysis compared to drug and disease references

## Query drug reference

```{r drug_enrichment, eval=TRUE}
...
## Query disease reference

```{r disease_enrichment, eval=FALSE}
PMID26490707 <- read.delim("./data/PMID26490707_S1.xls", comment="#", check.names=FALSE)
