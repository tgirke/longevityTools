...
The following intersects computes their intersects with each of the 3,318 drug-responsive 
DEG sets from CMAP. Subsequently, the Jaccard index is used as a simple similarity metric
and used to sort the results. The 20 top scoring results are given below and the full
