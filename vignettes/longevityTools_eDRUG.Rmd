...
The following `intersectStats` function computes their intersects with each of the 3,318 
...
sizes just by chance. The 20 top scoring drugs are given below and the full data set is 
written to a file named [`degOL_PMID26490707.xls`](http://biocluster.ucr.edu/~tgirke/projects/longevity/cmap/results/degOL_PMID26490707.xls).
...
similarity metric for gene sets as well as the raw and adjusted p-values based on the 
hypergeometric distribution expressing how likely it is to observe the observed intersect 
sizes just by chance. The 20 top scoring drugs are given below and the full
