...
<title>longevityToolsOverview - Analysis Tools for Longevity Research  | Manuals</title>
...
var body = "I have some feedback about the longevityToolsOverview - Analysis Tools for Longevity Research page: ";
                ...
                <li>
                    ...
                    <script type="text/javascript">
                        SimpleJekyllSearch.init({
                            ...
                            searchResultTemplate: '<li><a href="{url}" title="longevityToolsOverview - Analysis Tools for Longevity Research">{title}</a></li>',
...
<div class="row">
   ...
   <h1 class="post-title-main">longevityToolsOverview - Analysis Tools for Longevity Research</h1>
</div>
...
<!--
    ...
    <a target="_blank" href="https://github.com/tgirke/manuals/tree/master/mydoc//vignettes/03_longevityTools_Overview/longevityTools.Rmd" class="btn btn-default githubEditButton" role="button"><i class="fa fa-github fa-lg"></i> Edit me</a>
