...
<title>longevityDrugs: Database of Longevity-Associated Drugs (LAD)  | Manuals</title>
...
var body = "I have some feedback about the longevityDrugs: Database of Longevity-Associated Drugs (LAD) page: ";
                ...
                <li>
                    ...
                    <script type="text/javascript">
                        SimpleJekyllSearch.init({
                            ...
                            searchResultTemplate: '<li><a href="{url}" title="longevityDrugs: Database of Longevity-Associated Drugs (LAD)">{title}</a></li>',
...
<div class="row">
   ...
   <h1 class="post-title-main">longevityDrugs: Database of Longevity-Associated Drugs (LAD)</h1>
</div>
...
<!--
    ...
    <a target="_blank" href="https://github.com/tgirke/manuals/tree/master/mydoc//vignettes/06_longevityDrugs/longevityDrugs.Rmd" class="btn btn-default githubEditButton" role="button"><i class="fa fa-github fa-lg"></i> Edit me</a>
