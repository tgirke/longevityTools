...
#dat_effect <- dat_effect[,.(KGID,gene_name,effect_allele,non_effect_allele,rs_id_dbSNP142_GRCh37p13,maf,slope,effect,pval_nominal,qval,young_old_muscle )]
...
pheno[ ,dead90:=-9L ]
pheno[control60DA==1 ,dead90:=0L ]
pheno[cases90==1 ,dead90:=1L ]
pheno[dead90==-9 ,dead90:=NA ] 
L1<-glm(dead90 ~ IV + GIAGE1 + EV1 + EV2 + EV3 + EV4 ,data=pheno, family=binomial(link="logit"), maxit=50  )
summary(L1)
