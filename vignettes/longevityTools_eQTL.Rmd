...
Save results from geneGrep to external file gtex.txt 
Download 1KG genotype data in PLINK format here: https://www.cog-genomics.org/plink2/resources#1kg
Run clump command using default settings, but might want to change with different nominal significance thresholds.

```
plink -bfile 1kg_phase1_chr22 --clump gtex.txt
```
